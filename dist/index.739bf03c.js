...
var _slimselectCss = require("/src/css/slimselect.css");
...
function changeBreed(evt) {
    ...
    (0, _catApi.fetchCatByBreed)(id).then((data)=>{
        const cat = data[0];
        const catInfo = `
...
},{"./cat-api":"5IWAT","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","slim-select":"lzHUr","/src/css/slimselect.css":"8Vsvo"}],"5IWAT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_gENyqxI4CKTup2rVYxuz2kdHYhpulfAjA9RU9PsgU0gFtQRExezYdbdcj24XVkhs";
...
function fetchCatByBreed(breedId) {
    return (0, _axiosDefault.default).get(`/images/search?breed_ids=${breedId}`).then((response)=>response.data).catch((error)=>{
        throw error;
    });
}
...
},{}],"8Vsvo":[function() {},{}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequired7c6")
